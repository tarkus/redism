...
Redism = (function() {
  ...
  function Redism(options) {
    var connect_check, connected, name, scope, servers, total, _i, _len, _ref, _servers;
    ...
    if (!this.options.test_config) {
      ...
      _servers.forEach((function(_this) {
        return function(server) {
          var authparts, client, db, host, pass, port, serverparts, _ref1;
          ...
          if (_this.options.name) {
            ...
            return client.on('connect', connect_check);
          }
        };
      })(this));
    }
